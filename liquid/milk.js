...
function milkFromCupsToOthers(cup){
    cup = parseFloat(cup);
    if (cup<0){
    ...
    grams.value = Math.round(cup * 240);
    milliliters.value = Math.round(cup * 240);
    tablespoons.value = roundTo((cup * 16), 2);
    founces.value= roundTo( cup * 8,2);
    ounces.value= roundTo(cup * 8.345404, 2);
}

function milkFromTbspnsToOthers(tbspn){
    ...
    grams.value = Math.round(tbspn * 15);
    milliliters.value = Math.round(tbspn * 15);
    cups.value = roundTo((tbspn * (1/16)), 2);
    founces.value= roundTo(tbspn * 0.5, 2);
    ounces.value= roundTo(tbspn * 0.521588, 2);
}

function milkFromMLsToOthers(milliliter){
    ...
    tablespoons.value = roundTo((milliliter * (1/15)),2);
    cups.value = roundTo((milliliter * 0.0041667), 2);
    founces.value=roundTo(milliliter * 0.033814, 2);
    ounces.value= roundTo(milliliter * 0.035274, 2);
}

function milkFromGramsToOthers(gram){
    ...
    tablespoons.value = roundTo((gram * (1/15)),2);
    cups.value = roundTo((gram * 0.0041667), 2);
    founces.value=roundTo(gram * 0.033814, 2);
    ounces.value=roundTo(gram * 0.035274, 2);
}


function milkFromOuncesToOthers(ounce){
...
function milkFromFOuncesToOthers(founce){
